...
class two_tone_transmit(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "two_tone_transmit")
        ...
        self.soapy_limesdr_sink_0.set_bandwidth(0, 30e6)
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.qtgui_freq_sink_x_2, 0))
...
def main(top_block_cls=two_tone_transmit, options=None):
