...
import SUPR_XT_BPSK_epy_block_0 as epy_block_0  # embedded python block
import sip



class SUPR_XT_BPSK(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "SURP_TX_BPSK", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("SURP_TX_BPSK")
        ...
        self.settings = Qt.QSettings("GNU Radio", "SUPR_XT_BPSK")
        ...
        self.noise_volt = noise_volt = .010
        self.freq_offset = freq_offset = .001
        ...
        self._time_offset_range = qtgui.Range(.999, 1.001, .0001, 1.0001, 200)
        ...
        self.soapy_limesdr_sink_0.set_bandwidth(0, 5e6)
        self.soapy_limesdr_sink_0.set_frequency(0, 430e6)
        ...
        self._noise_volt_range = qtgui.Range(0, 1, .01, .010, 200)
        ...
        self._freq_offset_range = qtgui.Range(-0.1, 0.1, .001, .001, 200)
        ...
        self.digital_constellation_modulator_0 = digital.generic_mod(
            ...
            log=False,
            truncate=False)
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.cons(pmt.PMT_NIL,pmt.init_u8vector(4,(1,3,7,15))), 50)
...
def main(top_block_cls=SUPR_XT_BPSK, options=None):
